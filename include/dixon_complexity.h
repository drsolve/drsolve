...
typedef struct {
    ...
    double step4_ordinary_interp_log2;
    double step4_ordinary_grid_points_log2;
    double step4_ordinary_probe_cost_log2;
    double step4_ordinary_tensor_sum_log2;
    double step4_ordinary_probe_phase_log2;
    double step4_ordinary_tensor_phase_log2;
